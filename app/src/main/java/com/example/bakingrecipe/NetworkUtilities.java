...
import static com.example.bakingrecipe.JsonUtilities.extractFeatureFromJson;
...
public class NetworkUtilities {
    ...
    public static ArrayList<Recipes> fetchBakingData(String requestUrl) {
        ...
        ArrayList<Recipes> recipeList = extractFeatureFromJson(jsonResponse);
